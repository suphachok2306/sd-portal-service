...
public class DatabaseInitializer implements CommandLineRunner {
  ...
  private void insertBudgetTable() {
    String sql =
      "INSERT INTO public.budget (air_acc, class_name, \"exp\", fee, number_of_person, remark, \"year\",company_id, department_id)\n" +
      "VALUES\n" +
      ...
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,1),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,1),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023',1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (10.0, 'test', 20.0, 10.0, 100, '', '2023', 1,2),\n" +
      "    (1000.0, 'string', 2000.0, 1000.0, 0, 'string', '2023',1,2),\n" +
