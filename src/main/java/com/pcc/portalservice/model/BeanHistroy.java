...
public class BeanHistroy {
  ...
  public BeanHistroy(
    ...
    List<String> course_places,
    List<Float> course_prices,
    List<String> priceProjects,
    List<String> dates,
    Float sums,
    Float sumall,
    String name,
  ...
  public boolean equals(Object o) {
    ...
    return (
      Objects.equals(course_names, beanHistroy.course_names) &&
      Objects.equals(course_places, beanHistroy.course_places) &&
      Objects.equals(course_prices, beanHistroy.course_prices) &&
      Objects.equals(priceProjects, beanHistroy.priceProjects) &&
      Objects.equals(dates, beanHistroy.dates) &&
      Objects.equals(sums, beanHistroy.sums) &&
      Objects.equals(sumall, beanHistroy.sumall) &&
      Objects.equals(name, beanHistroy.name) &&
      Objects.equals(id, beanHistroy.id)
    );
  }
