...
public class BeanGeneric9 {
    ...
    public BeanGeneric9(List<String> course_names, List<String> result1s, List<String> result2s, List<String> result3s, List<String> result4s, List<String> result5s, List<String> result6s, List<String> result7s, String positionname, String name, Long id) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(course_names, beanGeneric9.course_names) && Objects.equals(result1s, beanGeneric9.result1s) && Objects.equals(result2s, beanGeneric9.result2s) && Objects.equals(result3s, beanGeneric9.result3s) && Objects.equals(result4s, beanGeneric9.result4s) && Objects.equals(result5s, beanGeneric9.result5s) && Objects.equals(result6s, beanGeneric9.result6s) && Objects.equals(result7s, beanGeneric9.result7s) && Objects.equals(positionname, beanGeneric9.positionname) && Objects.equals(name, beanGeneric9.name) && Objects.equals(id, beanGeneric9.id);
    }

    @Override
    public int hashCode() {
        return Objects.hash(course_names, result1s, result2s, result3s, result4s, result5s, result6s, result7s, positionname, name, id);
    }
    ...
    public String toString() {
        return "{" +
            ...
            ", result1s='" + getResult1s() + "'" +
            ", result2s='" + getResult2s() + "'" +
            ", result3s='" + getResult3s() + "'" +
            ", result4s='" + getResult4s() + "'" +
            ", result5s='" + getResult5s() + "'" +
            ", result6s='" + getResult6s() + "'" +
            ", result7s='" + getResult7s() + "'" +
