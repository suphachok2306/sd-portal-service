...
public class TrainingService {
  ...
  public String printReport(Long trainId) {
    ...
    User approve = userRepository
            .findById(training_id.getApprove1().getId())
            .orElseThrow(() ->
                    new RuntimeException(
                            "Approve1Id not found: " + training_id.getApprove1().getId()
                    )
            );
    ...
    if (vicePresidentRole == null) {
      ...
      try {
        ...
        params.put(
                "start_date",
                training_id.getCourses().get(0).getStartDate()
        );
...
//    Training training_id = findByTrainingId(trainId);
//    User user_id1 = userRepository.findById(userId1).orElseThrow(() -> new RuntimeException("UserId not found"));
//    User user_id2 = userRepository.findById(userId2).orElseThrow(() -> new RuntimeException("UserId not found"));
//    User user_id3 = userRepository.findById(userId3).orElseThrow(() -> new RuntimeException("UserId not found"));
//    User user_id4 = userRepository.findById(userId4).orElseThrow(() -> new RuntimeException("UserId not found"));
...
//        Map<String, Object> params = new HashMap<>();
//
//        String imageBase64User1 = convertByteToBase64(user_id1.getSignature().getImage());
//        String imageBase64User2 = convertByteToBase64(user_id2.getSignature().getImage());
//        String imageBase64User3 = convertByteToBase64(user_id3.getSignature().getImage());
//        String imageBase64User4 = convertByteToBase64(user_id4.getSignature().getImage());
//
//
