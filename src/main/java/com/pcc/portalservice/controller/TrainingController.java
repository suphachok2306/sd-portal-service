...
public class TrainingController {
  ...
  public ResponseEntity<List<Map<String, Object>>> findTrainingByTrainingId(
    @RequestParam Long trainingId
  ) {
  ...
  public ResponseEntity<List<Map<String, Object>>> findAllApprove(
    @RequestParam Long count
  ) {
    List<Map<String, Object>> training = trainingService.findbyAllCountApprove(
      count
    );
    if (count > 3) {
